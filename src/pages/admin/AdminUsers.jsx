...
const AdminUsers = () => {
 ...
 const filteredUsers = users.filter(
  (user) =>
    ...
    user.refree.toLowerCase().includes(searchTerm.toLowerCase())
);
        ...
        <table className="min-w-full">
          <thead className="bg-gradient-to-r from-blue-400 via-green-400 to-pink-400 text-white">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold">Refree Name</th>
          ...
          <tbody>
            {filteredUsers.map((user, index) => (
              ...
              >
                ...
                <td className="px-6 py-4 text-sm text-gray-700">{user.refree}</td>
